...
export const jobStatuses = ["assigned","accepted","in_progress","paused","pending_material","under_monitoring","completed","verified","closed","reopened","cancelled"] as const;
...
export type JobRow = {
  ...
  started_at:string|null;completed_at:string|null;scheduled_for?:string|null;action_taken:string|null;monitoring_note:string|null;monitoring_started_at:string|null;monitoring_review_at:string|null;pending_material_note:string|null;block:{id:number;code:string}|null;assignee?:{id:string;full_name:string}|null;complaint?:{id?:string;complaint_no:string}|null;
};
