...
const adminNav = [
  ...
  ["Analysis", "/admin/analysis", Gauge], ["Reports", "/admin/reports", FileBarChart], ["Servicing & Compliance", "/admin/compliance", ClipboardCheck], ["Notifications", "/admin/notifications", Bell],
