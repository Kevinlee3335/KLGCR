...
const staffNav = [["My Dashboard", "/staff"], ["My Tasks", "/staff/tasks"], ["Material Request", "#"], ["Monitoring", "#"], ["Appointments", "#"], ["Completed Jobs", "/staff/tasks?status=completed"]];
