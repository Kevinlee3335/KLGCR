...
const adminNav = [
  ...
  ["Reports", "/admin/reports", FileBarChart], ["Calendar", "/admin/calendar", CalendarDays], ["Notifications", "/admin/notifications", Bell],
  ["Users", "/admin/users", Users], ["Settings", "/admin/settings", Settings],
] as const;
const cleanerNav = [["My Calendar", "/staff/calendar"], ["Check-out Rooms", "/staff/checkouts"]] as const;
const staffNav = [["My Dashboard", "/staff"], ["My Tasks", "/staff/tasks"], ["My Calendar", "/staff/calendar"], ["Material Request", "/staff/material-request"], ["Monitoring", "/staff/monitoring"], ["Appointments", "/staff/appointments"], ["Completed Jobs", "/staff/tasks?status=completed"]];
