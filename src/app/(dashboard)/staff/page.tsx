...
export default async function StaffPage() {
  ...
  return <AppShell profile={profile} title="My Dashboard">
    ...
    <section className="panel" style={{marginTop:24}}>
      <div className="section-head"><div><h2>Today&apos;s Appointments</h2><p className="subtle">Scheduled maintenance visits assigned to you.</p></div><Link className="text-link" href="/staff/calendar">Open Calendar</Link></div>
