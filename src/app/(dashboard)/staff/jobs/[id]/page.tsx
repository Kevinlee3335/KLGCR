...
import { updateDefectProgress } from "./actions";

const successMessages: Record<string, string> = { "defect-updated": "Defect progress updated.", started: "Job started successfully.", completed: "Job completed successfully.", monitoring: "Monitoring details saved.", "pending-material": "Job marked as Pending Material.", resumed: "Job returned to In Progress.", "tenant-not-available": "Tenant not available recorded. The job remains open." };
