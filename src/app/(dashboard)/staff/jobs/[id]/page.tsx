...
const successMessages: Record<string, string> = { started: "Job started successfully.", completed: "Job completed successfully.", monitoring: "Monitoring details saved.", "pending-material": "Job marked as Pending Material.", resumed: "Job returned to In Progress." };
